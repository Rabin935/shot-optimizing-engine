...
export function BasketballCourt({
  ...
  // Render a scalable SVG half-court and layer interactive children above it.
  return (
    <div
    ...
    >
      ...
      >
        ...
        {showLines ? (
          // Court lines can be hidden to reduce visual clutter in the sandbox.
          <g
            fill="none"
            strokeLinecap="round"
        ...
        {showLabels ? (
          // Labels help users understand broad scoring zones on the court.
          <g
