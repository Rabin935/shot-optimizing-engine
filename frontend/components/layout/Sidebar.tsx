...
const navItems: NavItem[] = [
  // Primary app navigation items shown in desktop and mobile sidebars.
...
export function Sidebar() {
  // Track mobile sidebar state while desktop navigation stays always visible.
...
function SidebarContent({
  ...
  // Shared sidebar content is reused for both mobile drawer and desktop rail.
  return (
...
function SidebarLink({
  ...
  // Render one nav link with active-route styling.
...
function Brand() {
  // Brand mark links users back to the main sandbox workspace.
  return (
...
function isActiveRoute(pathname: string, href: string) {
  // Mark parent routes active when the current path is nested under them.
