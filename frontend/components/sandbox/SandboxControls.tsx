...
export function SandboxControls({
  ...
  // Controls let users switch scenarios, reset state, and toggle overlays.
  return (
...
function ToggleButton({
  ...
  // Toggle buttons expose boolean settings with aria-pressed for accessibility.
  return (
    <button
      type="button"
      aria-pressed={active}
...
function ControlReadout({ label, value }: { label: string; value: string }) {
  // Readouts mirror key live stats inside the controls area.
  return (
