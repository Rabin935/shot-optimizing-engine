...
export function SandboxExperience() {
  // Store all user-editable sandbox state at the top of the experience.
  ...
  const handleDefenderMove = (id: string, point: CourtPoint) => {
    // Update only the moved defender and mark the layout as custom.
  ...
  const resetPositions = () => {
    // Restore the initial court, defender, and overlay state.
